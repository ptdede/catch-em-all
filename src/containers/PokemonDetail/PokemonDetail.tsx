  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`You're vieweing details of pokemon ${pokemon.name}!`}
          key="description"
        />
      </Head>
      <TPokemonDetail.Wrapper>
        <TPokemonDetail.DetailWrapper>
          <TPokemonDetail.DetailContent color={colors.dominant}>
        ...
        <TPokemonDetail.AttributesWrapper>
          <TPokemonDetail.AttributesTitle>MOVES</TPokemonDetail.AttributesTitle>
        ...
        {!ownedName && (
          ...
          >
            <img src={require("public/pokeball.png")} alt="pokeball" />
          </TPokemonDetail.CatchWrapper>
        )}
      </TPokemonDetail.Wrapper>
    </>
