...
export const CatchPokemonContext = createContext<typeof defaultContext>(defaultContext);

export const useCatchPokemon = () => useContext(CatchPokemonContext);

export const CatchPokemonProvider = ({ children }: ICatchPokemonProviderProps) => {
